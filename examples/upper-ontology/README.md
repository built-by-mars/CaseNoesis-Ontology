...
CI validates these graphs with vendored CDO-Shapes profiles under `ontology/upper/shapes/`.
...
Builders do not invoke `case_validate` directly — CI validates outputs with profile shapes from `ontology/upper/shapes/`.
