...
def add_longtail(ctx: dict[str, Any]) -> list[str]:
    ...
    corp_marking = ctx["corp_marking"]

    # --- refs from main graph ---
    art_001 = ctx["art_001"]
    art_001_image = ctx["art_001_image"]
    art_002 = ctx["art_002"]
    art_002_source_macbook = ctx["art_002_source_macbook"]
    art_003 = ctx["art_003"]
    ...
    msg_004 = ctx["msg_004"]
    msg_006 = ctx["msg_006"]
    msg_006_facet = ctx["msg_006_facet"]
    ...
    victor_lam = ctx["victor_lam"]
    victim_7 = ctx["victim_7"]
