...
public class ContactAddress extends UcoInherentCharacterizationThing {
    ...
    public String getContactAddressScope() { return this.contactAddressScope; }
    public ContactAddress setContactAddressScope(String value) { this.contactAddressScope = value; return this; }
