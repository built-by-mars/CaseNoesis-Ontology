...
- CAC Ontology submodule (`extensions/cac/ontology`) updated to `a923beb` (upstream [release/v3.0.0](https://github.com/Project-VIC-International/CAC-Ontology), semantic spine refactoring) so v1.13.0 checkouts include the ontology files required by CAC validation subset and `cac:full` manifest loading.
