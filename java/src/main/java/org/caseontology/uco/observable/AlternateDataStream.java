...
public class AlternateDataStream extends FileSystemObject {
    public static final String CLASS_IRI = "https://ontology.unifiedcyberontology.org/uco/observable/AlternateDataStream";
