...
@dataclass
class AttackPattern:
    """An attack pattern is a common approach (set of actions) utilized by a person or organization to carry out malicious activity intended to achieve some particular objective (within a particular context)"""

    CLASS_IRI: str = "https://ontology.adversaryengagement.org/ae/attack/AttackPattern"
...
class CyberKillChain:
    ...
    CLASS_IRI: str = "https://ontology.adversaryengagement.org/ae/attack/CyberKillChain"
    created_by: Optional[IdentityAbstraction] = field(default=None)
    description: list[str] = field(default_factory=list)
    external_reference: list[ExternalReference] = field(default_factory=list)
    has_facet: list[Facet] = field(default_factory=list)
    ...
    spec_version: Optional[str] = field(default=None)
    tag: list[str] = field(default_factory=list)
    action_count: list[int] = field(default_factory=list)
    action_status: list[str] = field(default_factory=list)
    ...
    subaction: list[Action] = field(default_factory=list)
    phase: Optional[ArrayOfAction] = field(default=None)


@dataclass
class DefensePattern:
    """A defense pattern is a common approach (set of actions) utilized by a person or organization to carry out defensive activity intended to achieve some particular objective (within a particular context)"""

    CLASS_IRI: str = "https://ontology.adversaryengagement.org/ae/attack/DefensePattern"
    created_by: Optional[IdentityAbstraction] = field(default=None)
    description: list[str] = field(default_factory=list)
    external_reference: list[ExternalReference] = field(default_factory=list)
    has_facet: list[Facet] = field(default_factory=list)
